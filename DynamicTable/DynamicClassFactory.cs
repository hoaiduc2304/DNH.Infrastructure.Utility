    ...
    public class DynamicClassFactory
    {
            ...
            where T : DynamicEntity
        {
            if (_assemblyBuilder == null)
                _assemblyBuilder = AssemblyBuilder.DefineDynamicAssembly(new AssemblyName(_assemblyName), AssemblyBuilderAccess.Run);
        ...
        public void AddTableAttribute(string name)
        {
            ...
            _typeBuilder.SetCustomAttribute(new CustomAttributeBuilder(attrType.GetConstructor(new[] { typeof(string) }), new object[] { name }));
        }
